...
abstract class REST_Controller extends CI_Controller
{
     ...
     * @var array
     */
    protected $allowed_http_methods = array('get', 'delete', 'post', 'put','options');
    ...
    public function __construct()
    {
        ...
        $this->_args = array_merge($this->_get_args, $this->_put_args, $this->_post_args, $this->_delete_args, $this->_options_args, $this->{'_'.$this->request->method.'_args'});
    ...
    /**
     * Retrieve a value from the OPTIONS request arguments.
     *
     * @param string $key The key for the POST request argument to retrieve
     * @param boolean $xss_clean Whether the value should be XSS cleaned or not.
     * @return string The POST argument value.
